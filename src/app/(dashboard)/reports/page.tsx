...
export default function ReportsPage() {
  ...
  if (!user || user.role !== "admin") {
    return (
      <div className="p-8">
        <p className="text-[15px] text-[var(--text-secondary)]">Access denied. Admin only.</p>
      </div>
    );
  }
            ...
            <Card key={emp.employee._id} className="p-0 overflow-hidden">
              ...
              <div className="flex items-center gap-3 px-5 py-4 border-b border-[var(--border)] bg-[var(--bg-primary)]">
                <div className="w-10 h-10 rounded-full bg-[var(--accent-admin-dim)] flex items-center justify-center">
                  <span className="text-[15px] font-bold text-[var(--accent-admin-text)]">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    {emp.employee.role === "admin" && (
                      <span className="px-1.5 py-0.5 rounded text-[11px] font-semibold bg-[var(--accent-admin-dim)] text-[var(--accent-admin-text)]">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 p-5">
                ...
                <div className="text-center">
                  ...
                  <p className="text-[11px] text-[var(--text-muted)]">Overdue</p>
                </div>
                <div className="text-center">
                  <div className="flex items-center justify-center gap-1 mb-1">
                  ...
                  <p className="text-[11px] text-[var(--text-muted)]">Time Spent</p>
                </div>
                <div className="text-center">
                  <div className="flex items-center justify-center gap-1 mb-1">
                ...
                <div className="text-center">
                  ...
                  <p className="text-[11px] text-[var(--text-muted)]">Avg Completion</p>
                </div>
              </div>
                    ...
                    <table className="w-full text-left">
                      <thead>
                        <tr className="bg-[var(--bg-hover)]">
                          <th className="text-[11px] font-semibold text-[var(--text-muted)] uppercase px-3 py-2">Task</th>
                          <th className="text-[11px] font-semibold text-[var(--text-muted)] uppercase px-3 py-2">Brief</th>
                          <th className="text-[11px] font-semibold text-[var(--text-muted)] uppercase px-3 py-2">Status</th>
                          <th className="text-[11px] font-semibold text-[var(--text-muted)] uppercase px-3 py-2">Deadline</th>
                          <th className="text-[11px] font-semibold text-[var(--text-muted)] uppercase px-3 py-2">Time</th>
                        </tr>
                      </thead>
                      <tbody>
